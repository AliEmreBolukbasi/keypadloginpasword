...
{  
   ...
   if(donentus!=11 && donentus!=12 && sayac!=sifrebyt){                //en baþta þifre girmek için
      printf(lcd_putc,"\f");
   ...
   if(donentus==11){                         //þifre deðiþtirmek için þifre girin
      if(sayac != sifrebyt){                 //þifre daha önce girilmiþ mi
      output_low(pin_c1);
      printf(lcd_putc,"\f");
      printf(lcd_putc,"sifreyi girin\n");
      donentus=12;sayac=0;
